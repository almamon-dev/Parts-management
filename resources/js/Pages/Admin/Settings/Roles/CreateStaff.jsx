            ...
            <div className="p-8 max-w-4xl mx-auto">
                <div className="mb-8">
                    ...
                    <p className="text-sm text-gray-500 mt-1">
                        Create a new administrative account with specific roles
                        and permissions
                    </p>
                </div>
                                    ...
                                    <div className="grid grid-cols-1 gap-2">
                                        {roles.map((role) => (
                                            ...
                                            >
                                                <div>
                                                    <p
                                                        className={`text-sm font-semibold ${data.roles.includes(role.name) ? "text-[#FF9F43]" : "text-gray-700"}`}
                                                    >
                                                        {role.name}
                                                    </p>
                                        ...
                                        <div className="grid grid-cols-1 gap-1">
                                            {permissions.map((perm) => {
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <span
                                                            className={`text-xs font-medium ${isSelected ? "text-[#FF9F43]" : "text-gray-600"}`}
                                                        >
                                                            {perm.name.replace(
                                                                ".",
                                                                " / ",
