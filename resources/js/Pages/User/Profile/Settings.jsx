...
export default function SettingsPage() {
    ...
    const preferencesForm = useForm({
        store_hours: auth.user.store_hours || {
            start_day: "Monday",
            end_day: "Friday",
            start_time: "09.00 AM",
            end_time: "05.00 PM",
                                    ...
                                    {sidebarItems.map((item) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-3">
                                                <div
                                                    className={`w-8 h-8 rounded-lg flex items-center justify-center ${activeTab === item.id ? "bg-[#FFF0E6] text-[#AD0100]" : "text-slate-400"}`}
                                                >
                                                    <item.icon size={18} />
                                                </div>
                                    ...
                                    >
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            >
                                                ...
                                                <option value="Towing / Fleet Services">
                                                    Towing / Fleet Services
                                                </option>
                                                <option value="Auto Part Store">
                                                    Auto Part Store
                                                </option>
                                ...
                                {activeTab === "preferences" && (
                                    ...
                                    >
                                        ...
                                        <div className="space-y-4">
                                            <label className="text-xs font-bold text-slate-500 ml-1 tracking-wider uppercase">
                                                Store hours
                                            </label>
                                            ...
                                            <div className="space-y-3">
                                                {[
                                                    ...
                                                    >
                                                        ...
                                                        >
                                                            <div
                                                                className={`absolute top-1 left-1 w-4 h-4 bg-white rounded-full transition-transform duration-300 ${preferencesForm.data[pref.id] ? "translate-x-6" : ""}`}
                                                            />
                                                        </button>
                                                    </div>
                                                ))}
