                        ...
                        {firstImage ? (
                            ...
                            <div className="flex flex-col items-center gap-2 text-slate-300">
                                <ImageOff
                                    ...
                                    strokeWidth={1}
                                />
                                <span className="text-[8px] md:text-[10px] font-bold uppercase tracking-widest text-center px-2">
                                    No Image
                                </span>
                            </div>
                        )}
                    ...
                    <div className="mt-auto pt-3 md:pt-4 border-t border-slate-50 flex items-end justify-between gap-2 md:gap-4">
                        ...
                        <div className="flex items-center gap-1.5 md:gap-2">
                            ...
                            >
                                <ShoppingCart
                                    size={16}
                                    className="md:w-[18px] transition-transform group-hover/btn:scale-110"
                                />
                            </button>
                        </div>
                    </div>
...
export default function Dashboard({
    ...
    const categories =
        dynamicCategories?.length > 0 ? dynamicCategories : defaultCategories;
            ...
            <div className="p-4 md:p-8 bg-[#F8F9FB] min-h-screen">
                <div className="max-w-9xl mx-auto space-y-6 md:space-y-8">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        ...
                        <div className="flex flex-col gap-4">
                            <StatCard
                                ...
                                onClick={() =>
                                    router.get(route("orders.active"))
                                }
                            />
                            <StatCard
                                icon={
                    ...
                    <div className="space-y-16 py-10">
                        ...
                        />
                        <ProductSection
                            title="Shop Electrical Items"
                            products={sections?.electricalItems}
                        />
                        <ProductSection
