...
const Index = ({ roles, permissions }) => {
    ...
    const submitPermissions = (e) => {
        e.preventDefault();
        post(
            route("admin.settings.roles.permissions.update", selectedRole.id),
            {
                preserveScroll: true,
            },
        );
                                ...
                                {selectedRole.name === "Admin" ? (
                                    <div className="bg-orange-50 border border-orange-100 rounded-xl p-8 text-center space-y-3">
                                        ...
                                        <p className="text-gray-500 max-w-md mx-auto">
                                            ...
                                            role has implicit access to all
                                            system features and permissions. No
